    ...
    useEffect(() => {
        ...
        const getSerie = async () => {
            ...
            try {
                ...
                if (!serieData) {
                    toast.warning(
                        'serie não encontrado no catálogo.',
                    )
                    return
                }
    ...
    if (deleted) {
        return (
            <div className={styles.successState}>
                ...
                <p>
                    O serie com TMDB ID {tmdbid} foi removido do
                    catálogo.
                </p>
    ...
    if (!serie) {
        return (
            <div className={styles.notFoundState}>
                ...
                <p>
                    Não existe um serie com o TMDB ID {tmdbid} no
                    catálogo.
                </p>
            </div>
        )
        ...
        <section className={styles.container}>
            ...
            <article className={styles.serieCard}>
                ...
                <div className={styles.serieDetails}>
                    ...
                    <div className={styles.metadata}>
                        ...
                        {serie.season.length && (
                            <span>{serie.season.length} {serie.season.length > 1 ? 'Temporadas' : 'Temporada'}</span>
                        )}

                        {serie.faixa && (
                            <span>{serie.faixa}</span>
                        )}
                    </div>
            ...
            <label className={styles.confirmation}>
                ...
                <span>
                    ...
                    <strong>{serie.title}</strong> do catálogo.
                </span>
            </label>
