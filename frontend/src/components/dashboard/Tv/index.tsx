...
const TVDash = ({ id }: TVDashProps) => {
    const initialId = isValidTVId(id)
        ? id
        : undefined

    const [action, setAction] = useState<TVAction>(
    ...
    const handleSearch = (
        ...
        if (!isValidTVId(parsedId)) {
            ...
            setIdError(
                'Informe um ID válido maior que zero.',
            )
    ...
    return (
        <div className={styles.container}>
            <section className={styles.searchPanel}>
                <div className={styles.searchHeader}>
                    ...
                    <div>
                        ...
                        <small>
                            Informe o ID do TMDB para editar ou
                            excluir
                        </small>
                    </div>
                </div>
            ...
            <nav
                ...
                aria-label="Ações de gerenciamento de séries"
            >
                ...
                <ul className={styles.actionList}>
                    {ACTIONS.map((item) => {
                        ...
                        const isDisabled =
                            item.requiresId && !hasTVId

                        return (
                            <li key={item.action}>
                                <button
                                    type="button"
                                    className={`${styles.actionButton} ${isActive
                                        ? styles.active
                                        : ''
                                        } ${item.action === 'delete'
                                            ? styles.danger
