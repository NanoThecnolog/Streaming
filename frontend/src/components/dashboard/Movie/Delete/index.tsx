  ...
  if (deleted) {
    return (
      <div className={styles.successState}>
        ...
        <p>O filme com TMDB ID {tmdbid} foi removido do catálogo.</p>

        <small>Selecione outro ID para continuar gerenciando os filmes.</small>
      </div>
    )
  }
    ...
    <section className={styles.container}>
      ...
      <article className={styles.movieCard}>
        ...
        <div className={styles.movieDetails}>
          <div className={styles.contentType}>Filme selecionado</div>
          ...
          <div className={styles.metadata}>
            ...
            {movie.faixa && <span>{movie.faixa}</span>}
      ...
      <label className={styles.confirmation}>
        ...
        <span>
          Confirmo que desejo remover permanentemente <strong>{movie.title}</strong> do catálogo.
        </span>
      </label>
      ...
      <div className={styles.actions}>
        ...
        >
          ...
          {deleting ? 'Excluindo filme...' : 'Excluir permanentemente'}
        </button>
      </div>
    </section>
  )
