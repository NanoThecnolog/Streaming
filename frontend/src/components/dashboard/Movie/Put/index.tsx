...
const Put = ({ tmdbid }: PutProps) => {
  ...
  const genres = [...Object.values(gen), ...Object.values(agp), ...Object.values(stm)]
  ...
  useEffect(() => {
    ...
    const getMovie = async () => {
      ...
      try {
        ...
        if (!movie) {
          toast.warning('Filme não encontrado no catálogo.')
          return
        }
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await mongoService.updateMovie(tmdbid, updatedMovie)
  ...
  if (!movieFound) {
    return (
      <div className={styles.notFoundState}>
        ...
        <p>Não existe um filme com o TMDB ID {tmdbid} no catálogo.</p>

        <small>Use a opção Adicionar caso queira cadastrar esse conteúdo.</small>
      </div>
    )
  }
  ...
  return (
    <form className={styles.form} onSubmit={handleSubmit}>
      ...
      <div className={styles.formRow}>
        <div className={styles.mainFields}>
          ...
          <div className={styles.inlineFields}>
            <div className={styles.formItem}>
              ...
              >
                {classification.map((item) => (
                  <option key={item.etaria} value={item.etaria}>
                    {item.etaria}
                  </option>
                ))}
              </select>
            ...
            <div className={styles.formItem}>
              <label htmlFor="lang">Disponibilidade</label>
          ...
          <div className={styles.formItem}>
            <label htmlFor="src">Link do conteúdo</label>
      ...
      <div className={styles.buttonContainer}>
        <button type="submit" disabled={saving || !movieData.title.trim() || !movieData.src.trim()}>
