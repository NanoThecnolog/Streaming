  ...
  return (
    <div className={styles.container}>
      <div className={styles.item}>
        <div className={styles.header} onClick={() => handleSelect('credit')}>
          ...
          <IoIosArrowDown
            className={`
                            ${styles.arrow} ${paymentType === 'credit' ? styles.open : ''}`}
          />
        </div>
        <div
          className={`
      ...
      <div className={styles.item}>
        <div className={styles.header} onClick={() => handleSelect('billet')}>
          <div className={styles.method}>
        ...
        <div className={`${styles.dropdown} ${paymentType === 'billet' ? styles.open : ''}`}>
