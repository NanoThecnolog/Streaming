...
import { fetchTMDBBackDrop } from '@/services/fetchTMDBData';
    ...
    useEffect(() => {
        async function getImage() {
            if (cachedImages[card.tmdbId]) {
                ...
                const url = data ? `https://image.tmdb.org/t/p/w500${data.backdrop_path}` : await fetchTMDBBackDrop(card.tmdbId)
