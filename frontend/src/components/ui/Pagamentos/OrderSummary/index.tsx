...
export function OrderSummary({ plan, email }: OrderSummaryProps) {
  ...
  return (
    <section className={styles.card}>
      ...
      <div className={styles.plan}>
        ...
        <strong>{plan && formatPrice(plan.price)}</strong>
      </div>
      ...
      <div className={styles.details}>
        <div>
          ...
          <strong>{email || 'Ainda não informado'}</strong>
        </div>
      ...
      <div className={styles.safe}>
        ...
        <div>
          ...
          <p>Seus dados são enviados por conexão criptografada.</p>
        </div>
      </div>
    </section>
  )
