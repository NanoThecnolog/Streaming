...
const DropdownMenuModal = ({ user, signOut }: Props) => {
  ...
  return (
    <div className={styles.dropdownModal} role="menu" aria-label="Menu da conta">
      {user && (
      ...
      <ul className={styles.menuList}>
        {user ? (
          <>
            <li>
              <Link href="/me" className={styles.menuItem} role="menuitem">
            ...
            <li>
              <Link href="/watchlater" className={styles.menuItem} role="menuitem">
                <span className={styles.icon}>
                  <FaListUl size={18} />
                </span>
          ...
          <>
            <li>
              <Link href="/login" className={styles.menuItem} role="menuitem">
                <span className={styles.icon}>
                  <FaSignInAlt size={18} />
                </span>
