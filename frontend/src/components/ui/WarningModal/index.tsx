        ...
        >
            ...
            >
                ...
                <div className={styles.content}>
                    ...
                    >
                        Ative sua assinatura para assistir ao conteúdo e
                    ...
                    <div className={styles.paymentNotice}>
                        ...
                        <p>
                            Pagamento por cartão de crédito ou boleto bancário, com opção de
                            pagamento via Pix. O valor contribui com a
                            manutenção e os custos operacionais da plataforma.
                        </p>
                    </div>

                    {!subscription && (
                        <p className={styles.availability}>
                            O número de contas ativas pode ser limitado.
                        </p>
                    )}

                    <p className={styles.support}>
                        Precisa de ajuda? Entre em contato pelo e-mail{' '}
                        <a href="mailto:suporte@flixnext.com.br">
                            suporte@flixnext.com.br
                        </a>
                    </p>
                </div>
