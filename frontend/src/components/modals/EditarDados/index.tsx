...
export default function EditarDados({
    ...
    const passwordIsValid =
        !hasPasswordChanged || isPasswordValid
    ...
    const handleDados = async (
        ...
        try {
            ...
            const { data: updatedUser } =
                await axios.get<UserContext>('/api/user')
                ...
                >
                    ...
                    <div className={styles.section}>
                        <div className={styles.sectionHeader}>
                            ...
                            <p>
                                Deixe os campos vazios para manter
                                sua senha atual.
                            </p>
                        </div>
                        ...
                        {hasPasswordChanged && (
                            <div
                                className={styles.passwordChecker}
                                aria-live="polite"
                            >
