...
const Carousel = ({
    ...
    const availableSeries = series
        .filter((serie) => Boolean(serie.poster_path))
        .slice(0, 20)
    ...
    return (
        ...
        >
            ...
            <header className={styles.header}>
                ...
                <p>
                    Descubra filmes e séries selecionados entre os conteúdos
                    disponíveis na FlixNext.
                </p>
            </header>
            ...
            <div className={styles.footer}>
                <p>
                    Filmes, séries e novidades adicionados regularmente.
                </p>
