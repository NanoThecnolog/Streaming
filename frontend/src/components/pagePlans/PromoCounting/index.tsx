...
import {
    planValues,
    streamingPrices,
} from '@/utils/Variaveis'

import styles from './styles.module.scss'

const PromoCounting = () => {
    const streamingTotal = streamingPrices.reduce(
        (total, streaming) => total + streaming.price,
        0,
    )

    const monthlyPlanPrice = planValues.mensal
    const monthlySavings = Math.max(
        streamingTotal - monthlyPlanPrice,
        0,
    )

    const savingsPercentage =
        streamingTotal > 0
            ? Math.round((monthlySavings / streamingTotal) * 100)
            : 0
    ...
    return (
        ...
        >
            ...
            <div className={styles.header}>
                ...
                <p>
                    Assinar diferentes plataformas para acompanhar filmes e
                    séries pode representar um custo significativo todos os
                    meses.
                </p>
            </div>
            ...
            <div className={styles.comparison}>
                <article className={styles.streamingCard}>
                    <div className={styles.cardHeader}>
                        ...
                        <span className={styles.serviceCount}>
                            {streamingPrices.length} serviços
                        </span>
                    </div>
                    ...
                    <p className={styles.priceNotice}>
                        Valores baseados nos preços informados na comparação
                        e sujeitos a alterações pelas plataformas.
                    </p>
                </article>
                ...
                <article className={styles.flixnextCard}>
                    ...
                    <p className={styles.description}>
                        Um catálogo amplo e organizado em um único ambiente,
                        sem precisar alternar entre diferentes serviços.
                    </p>
                    ...
                    <div className={styles.savings}>
                        ...
                        <p>
                            ...
                            <strong>
                                {' '}
                                {formatPrice(monthlySavings)} por mês
                            </strong>
                        </p>
                    </div>
