...
export default function Active({ id }: ActiveProps) {
  ...
  const containerStyles = {
    backgroundImage:
      'url(https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwallpaperaccess.com%2Ffull%2F4321344.jpg&f=1&nofb=1&ipt=e561bcf964fd269c74214638aaa624daf5819fa9a9458a1033209e52c3d2ab80&ipo=images)',
        ...
        <div className={styles.container} style={containerStyles}>
          <div className={styles.cardContainer}>
            <div className={styles.contentContainer}>
              <h2>Olá, {`${activeUser?.name}!` || 'usuario'} Sua conta foi ativada com sucesso!</h2>
