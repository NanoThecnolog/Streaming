  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Painel administrativo do FlixNext" />
      ...
      <main className={styles.container}>
        <header className={styles.pageHeader}>
          <div className={styles.pageTitle}>
            ...
            <div>
              ...
              <p>Cadastre, edite e organize o catálogo do FlixNext.</p>
            </div>
          </div>

          <span className={styles.privateBadge}>Acesso privado</span>
        </header>
        ...
        <div className={styles.dashboardLayout}>
          <aside className={styles.sidebar}>
            ...
            <nav className={styles.menuContainer} aria-label="Tipos de conteúdo">
              {MENU_ITEMS.map((item) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  try {
    const response = await client.api.get<AccessResponse>('/user/access')
    ...
    console.error('Erro ao verificar acesso ao painel administrativo:', error)
