                ...
                >
                    {success ? (
                        ...
                        >
                            ...
                            <p>
                                Você já pode entrar na sua conta utilizando
                                a nova senha.
                            </p>
                        ...
                        <div className={styles.invalidToken}>
                            ...
                            <p>
                                Solicite um novo link de recuperação para
                        ...
                        <>
                            <header className={styles.header}>
                                ...
                                <p>
                                    Escolha uma senha segura e diferente das
                            ...
                            >
                                ...
                                <div className={styles.field}>
                                    ...
                                    <div
                                        className={`${styles.passwordInput} ${confirmPassword &&
                                            !passwordsMatch
                                            ? styles.inputError
                                            : ''
                                            }`}
                            ...
                            <footer className={styles.security}>
                                ...
                                <span>
                                    Sua senha será enviada por uma conexão
                                    segura.
                                </span>
                            </footer>
                        </>
