          ...
          <section className={styles.statusCard}>
            <div>
              ...
              <span
                ...
                style={{ backgroundColor: services.front ? 'green' : 'red' }}
              ></span>
            </div>
            <div>
              ...
              <span
                className={styles.statusSignal}
                style={{ backgroundColor: services.back ? 'green' : 'red' }}
              ></span>
            </div>
            <div>
              ...
              <span
                className={styles.statusSignal}
                style={{ backgroundColor: services.sub ? 'green' : 'red' }}
              ></span>
            </div>
            <div>
              ...
              <span
                className={styles.statusSignal}
                style={{ backgroundColor: services.messenger ? 'green' : 'red' }}
              ></span>
            </div>
            <div>
              ...
              <span
                className={styles.statusSignal}
                style={{ backgroundColor: services.dbmanager ? 'green' : 'red' }}
              ></span>
            </div>
          </section>
