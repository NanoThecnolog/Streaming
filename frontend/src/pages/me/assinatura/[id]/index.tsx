...
export default function SubscriptionPage({ subscription }: SubscriptionPageProps) {
  ...
  const handleConfirmCancel = async (): Promise<void> => {
    ...
    try {
      ...
      debug.log('Erro ao cancelar assinatura', error)
  ...
  const subscriptionStatus = Normalize.subscriptionStatus(assinatura.status)
      ...
      <main className={styles.container}>
        <div className={styles.card}>
          <header className={styles.pageHeader}>
            ...
            <div className={styles.headerText}>
              ...
              <p>Gerencie seu plano, forma de pagamento e cobranças.</p>
            </div>

            <span
              className={`
                                ${styles.statusBadge}
                                ${getSubscriptionStatusClass(assinatura.status)}
                            `}
            >
              {subscriptionStatus}
            </span>
          ...
          <section className={styles.subscriptionHero}>
            <div className={styles.planInfo}>
              ...
              <div>
                ...
                <p>Assinatura #{assinatura.subscription_id}</p>
              </div>
            </div>
            ...
            <div className={styles.planPrice}>
              ...
              <strong>{formatCurrency(assinatura.value)}</strong>
          ...
          {trialInfo && (
            <section className={styles.trialNotice}>
              ...
              <div className={styles.trialContent}>
                ...
                <p>Seu período gratuito termina em {formatedDate(trialInfo.endsAt)}.</p>
              </div>
            </section>
          )}
          ...
          <section className={styles.summaryGrid}>
            <article className={styles.summaryCard}>
              ...
              <div>
                ...
                <strong>{getPaymentMethodLabel(assinatura.payment_method || '')}</strong>
              </div>
            </article>
                ...
                <div>
                  ...
                  <strong>
                    {assinatura.next_expire_at
                      ? formatedDate(assinatura.next_expire_at)
                      : 'Não definido'}
                  </strong>
                </div>
              </article>
              ...
              {active ? (
                <>
                  <button
                    ...
                    onClick={() => setChangeMethodModal(true)}
                  >
                    <CreditCard size={18} />

                    <div>
                      <strong>Alterar pagamento</strong>

                      <span>Escolha outro método</span>
                    </div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <span>Interromper renovação</span>
                    </div>
                ...
                <button
                  type="button"
                  className={styles.actionPrimary}
                  onClick={() => router.push('/me/escolher-plano')}
                >
                  <RefreshCw size={18} />
                  ...
                  <div>
                    ...
                    <span>Escolha um novo plano</span>
                  </div>
              ...
              {active ? (
                <>
                  <div className={styles.infoItem}>
                    ...
                    <strong>#{assinatura.subscription_id}</strong>
                  </div>
              ...
              <section className={styles.section}>
                ...
                {assinatura.history.length > 0 ? (
                    ...
                    {assinatura.history.map((item, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className={styles.chargeMain}>
                            <span>Cobrança</span>

                            <strong>#{item.charge_id}</strong>
                          </div>
                          ...
                          <div className={styles.chargeDetail}>
                            ...
                            <strong>{formatedDate(item.created_at)}</strong>
                          </div>

                          <ChevronRight size={20} className={styles.chargeArrow} />
                        </button>
                      )
                    })}
                  </div>
                  ...
                  <div className={styles.emptyHistory}>
                    ...
                    <span>O histórico aparecerá quando uma cobrança for gerada.</span>
                  </div>
                )}
              </section>
            </>
        ...
        {showCancelModal && (
          <CancelSubModal
            ...
            handleShowCancelModal={() => setShowCancelModal(false)}
        ...
        {chargeModalOpen && (
          <ChargeModal
            ...
            method={assinatura.payment_method}
...
export const getServerSideProps: GetServerSideProps<SubscriptionPageProps> = async (context) => {
  ...
  try {
    const subscription = await userMethod.getSubscriptionDetails(parsedId)
