...
type SearchResult =
    | (CardsProps & { type: 'movie' })
    | (SeriesProps & { type: 'series' })
...
export default function Search() {
    ...
    const filteredResults = useMemo<SearchResult[]>(() => {
        ...
        const normalizedInput = normalizeSearch(
    ...
    const handleFilter = (
        ...
        const hasActiveFilter = Object.values(nextFilters).some(
            (value) => value !== '',
        )
        ...
        const query = nextFilters.input
            ? { input: nextFilters.input }
            : {}
        ...
        <>
            ...
            <main className={styles.page}>
                ...
                >
                    ...
                    <h1 id="search-title">
                        Encontre o que assistir
                    </h1>

                    <p>
                        Pesquise pelo título ou use os filtros para
                        explorar o catálogo da FlixNext.
                    </p>
                </section>

                <section
                    className={styles.searchSection}
                    aria-label="Pesquisa de conteúdos"
                >
                    <Filter
                        title={input}
                        genre={genre}
                    ...
                    {!isLoadingCatalog &&
                        ...
                        !hasSearched && (
                            <div className={styles.initialState}>
                                ...
                                <p>
                                    Informe um título ou selecione um dos
                                    filtros disponíveis.
                                </p>
                            </div>
                        )}
