                ...
                >
                    <div className={styles.heroContent}>
                        ...
                        <p className={styles.description}>
                            ...
                            ou fale diretamente com a nossa equipe de
                            suporte.
                        </p>
                        ...
                        <div className={styles.supportCard}>
                            ...
                            <div className={styles.supportContent}>
                                ...
                                <p>
                                    Descreva o problema e, se possível,
                                    informe o e-mail cadastrado na sua
                                    conta.
                                </p>
                        ...
                        <p className={styles.contactHint}>
                            Para agilizar o atendimento, inclua detalhes
                            sobre o erro e o dispositivo utilizado.
                        </p>
                    </div>
                </section>
                ...
                >
                    <header className={styles.faqHeader}>
                        ...
                        <div>
                            ...
                            <p>
                                Consulte as respostas antes de entrar em
